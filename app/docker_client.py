...
class DockerClient:
    def __init__(self) -> None:
        try:
            ...
            raise DockerException(f"Error initializing Docker client: {e}") from e
    ...
    def list_running_containers(self) -> List[Dict[str, Any]]:
        try:
            ...
            raise DockerException(f"Error listing running containers: {e}") from e
    ...
    def get_container_stats(self, container_id: str) -> Dict[str, Any]:
        try:
            ...
            raise DockerException(f"Error getting container stats: {e}") from e
    ...
    def get_container_metadata(self, container_id: str) -> Dict[str, Any]:
        try:
            ...
            raise DockerException(f"Error getting container metadata: {e}") from e